...
-----------------
	...
	ALT                  c                  ->   ActivateCopyMode
	SHIFT | CTRL         c                  ->   CopyTo(Clipboard)
	SUPER                c                  ->   CopyTo(Clipboard)
	SHIFT | CTRL         f                  ->   Search(CurrentSelectionOrEmptyString)
	SUPER                f                  ->   Search(CurrentSelectionOrEmptyString)
	ALT                  h                  ->   ActivatePaneDirection(Left)
	ALT                  j                  ->   ActivatePaneDirection(Down)
	ALT                  k                  ->   ActivatePaneDirection(Up)
	SHIFT | CTRL         k                  ->   ClearScrollback(ScrollbackOnly)
	SUPER                k                  ->   ClearScrollback(ScrollbackOnly)
	ALT                  l                  ->   ActivatePaneDirection(Right)
	SHIFT | CTRL         l                  ->   ShowDebugOverlay
	SHIFT | CTRL         m                  ->   Hide
	SUPER                m                  ->   Hide
	ALT                  n                  ->   ActivateTabRelative(1)
	SHIFT | CTRL         n                  ->   SpawnWindow
	SUPER                n                  ->   SpawnWindow
	ALT                  p                  ->   ActivateTabRelative(-1)
	SHIFT | CTRL         p                  ->   ActivateCommandPalette
	SHIFT | CTRL         r                  ->   ReloadConfiguration
...
--------------------
	...
	SHIFT   Tab          ->   CopyMode(MoveBackwardWord)
	        ...
	        Escape       ->   Multiple([ScrollToBottom, CopyMode(Close)])
	...
	CTRL    c            ->   Multiple([ScrollToBottom, CopyMode(Close)])
	...
	CTRL    g            ->   Multiple([ScrollToBottom, CopyMode(Close)])
	        h            ->   CopyMode(MoveLeft)
	        j            ->   CopyMode(MoveDown)
	        k            ->   CopyMode(MoveUp)
	...
	ALT     m            ->   CopyMode(MoveToStartOfLineContent)
	        ...
	        q            ->   Multiple([ScrollToBottom, CopyMode(Close)])
	...
	CTRL    v            ->   CopyMode(SetSelectionMode(Some(Block)))
	        ...
	        y            ->   Multiple([CopyTo(ClipboardAndPrimarySelection), Multiple([ScrollToBottom, CopyMode(Close)])])
